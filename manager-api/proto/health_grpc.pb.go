...
const (
	Health_Ping_FullMethodName = "/health.Health/Ping"
)
...
func (c *healthClient) Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (UnimplementedHealthServer) Ping(context.Context, *Request) (*Response, error) {
...
func _Health_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServer).Ping(ctx, req.(*Request))
	}
...
var Health_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "manager-api/api/health.proto",
}
